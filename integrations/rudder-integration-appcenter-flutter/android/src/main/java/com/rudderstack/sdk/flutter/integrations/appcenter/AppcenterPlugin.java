package com.rudderstack.sdk.flutter.integrations.appcenter;
...
/** AppcenterPlugin */
public class AppcenterPlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public void onAttachedToEngine(
    ...
    channel =
      new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "appcenter");
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    if (call.method.equals("addFactory")) {
      RudderSdkFlutterPlugin.addIntegration(
