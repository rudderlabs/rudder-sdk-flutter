...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  FlutterMethodChannel* channel =
      [FlutterMethodChannel methodChannelWithName:@"rudder_integration_leanplum_flutter"
                                  binaryMessenger:[registrar messenger]];
  RudderIntegrationLeanplumFlutterPlugin* instance =
      [[RudderIntegrationLeanplumFlutterPlugin alloc] init];
