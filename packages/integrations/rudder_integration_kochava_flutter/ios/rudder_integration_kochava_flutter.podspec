...
# Run `pod lib lint rudder_integration_kochava_flutter.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'rudder_integration_kochava_flutter'
  s.version          = '1.0.0'
  s.summary          = "RudderStack's Flutter Device Mode for the Kochava Destination"
  s.description      = <<-DESC
