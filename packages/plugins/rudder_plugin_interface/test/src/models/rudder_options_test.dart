...
void main() {
  ...
  Map<String, Object> invalidNumbers = {
    "nan": double.nan,
  ...
  RudderOption getRudderOptionsWithContextOnly() {
    ...
    rudderOption.putCustomContext("invalidNumbers", invalidNumbers);
    return rudderOption;
  }
  ...
  Map<String, Object> invalidIntegrationObject = {
    "clientId":
        "RS_ENC_v3_ImYzMzk0NGFiLWZhTkyY2I4M2M5NzNjMiI=DESUONHISRE350ONHYDROADS",
    "sessionId": 1691417767501,
    "sessionNumber": 21.365,
    "invalidNumbers": [
      double.nan,
      double.infinity,
      double.negativeInfinity,
  ...
  Map<String, Object> sanitizedIntegrationObject = {
    "clientId":
        "RS_ENC_v3_ImYzMzk0NGFiLWZhTkyY2I4M2M5NzNjMiI=DESUONHISRE350ONHYDROADS",
    "sessionId": 1691417767501,
    "sessionNumber": 21.365,
  ...
  RudderOption getRudderOptionsWithIntegrationsOnly() {
    ...
    rudderOption.putIntegration("invalidIntegration", invalidIntegrationObject);
    ...
    rudderOption.putIntegrationWithFactory(
        create(() => {}, "custom-factory-4"), invalidIntegrationObject);
    return rudderOption;
  }

  group('Rudder Options', () {
    test(
      ...
      expect(
          rudderOption.customContexts!["qualification"], qualificationContext);
      expect(
          (rudderOption.toMobileMap()["customContexts"]
    ...
    test(
      ...
      expect(rudderOption.integrations!["invalidIntegration"],
          sanitizedIntegrationObject);
      expect(rudderOption.integrations!["custom-factory-4"],
          sanitizedIntegrationObject);
    });
