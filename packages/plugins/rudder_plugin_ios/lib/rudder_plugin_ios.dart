...
///
/// This class handles all analytics events and configuration for iOS devices,
...
class RudderSdkFlutterIos extends RudderSdkPlatform {
  ...
  /// of the RudderStack SDK. It sets up the platform channel communication
  /// with the native iOS SDK.
